...
public:
	...
	float                                              DebugAngle;                                               // 0x0B08(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
class UCreativeApiObject : public UObject
{
public:
	unsigned char                                      UnknownData00[0x7C];                                      // 0x001C(0x007C) MISSED OFFSET
	struct FString                                     LuaFilePath;                                              // 0x0098(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	unsigned char                                      UnknownData01[0x4];                                       // 0x00A4(0x0004) MISSED OFFSET
	struct FString                                     ModuleName;                                               // 0x00A8(0x000C) (BlueprintVisible, ZeroConstructor)
	TArray<struct FString>                             CrossVMAPIs;                                              // 0x00B4(0x000C) (ZeroConstructor)
	TArray<struct FString>                             UGCVMAPIs;                                                // 0x00C0(0x000C) (ZeroConstructor)
	struct FString                                     UGCVMAPILuaFilePath;                                      // 0x00CC(0x000C) (ZeroConstructor)
	bool                                               bEnableRegisterCClosureApi;                               // 0x00D8(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x00D9(0x0003) MISSED OFFSET
	class UGameLuaAPI*                                 GameLuaAPI;                                               // 0x00DC(0x0004) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	class UBlockyGraphData*                            GraphDataObject;                                          // 0x022C(0x0004) (ZeroConstructor, IsPlainOldData)
	...
	class UBlockyGraphData* GetGraphDataObjectFormContent(TArray<unsigned char> GrapbAstContent, TArray<unsigned char> GlobalVarAstContent);
	...
	TArray<struct FString> GenerateLuaCodeFormContent(TArray<unsigned char> GrapbAstContent, TArray<unsigned char> GlobalVarAstContent, bool GenGlobalVarLua);
...
// 0x00D8 (0x1960 - 0x1888)
class ACreativeModeGameMode : public ABattleRoyaleGameModeTeam
{
public:
	TArray<class UClass*>                              GameModeComponentClassArray;                              // 0x1888(0x000C) (ZeroConstructor, Transient)
	class UClass*                                      GameModeComponentClass;                                   // 0x1894(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TMap<struct FString, struct FGameModeParam>        MapPlaneRouteConfigs;                                     // 0x1898(0x0050) (Edit, ZeroConstructor, DisableEditOnInstance)
	TMap<struct FString, struct FString>               MapVehicleClassPathConfigs;                               // 0x18D4(0x0050) (Edit, ZeroConstructor, DisableEditOnInstance)
	ECreativeModeGameType                              EditorStartupGameType;                                    // 0x1910(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x1];                                       // 0x1911(0x0001) MISSED OFFSET
	bool                                               bIsCreativeWoW;                                           // 0x1912(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x1];                                       // 0x1913(0x0001) MISSED OFFSET
	struct FGameModeLiteComponentTickFunction          LiteComponentActorTick;                                   // 0x1914(0x003C) (Edit, DisableEditOnInstance)
	TArray<class ULiteComponent*>                      LiteComponents;                                           // 0x1950(0x000C) (ZeroConstructor, Transient)
...
// 0x0090 (0x10B8 - 0x1028)
class ACreativeModeGameState : public ASTExtraGameStateBase
{
public:
	ECreativeModeGameType                              InitializeGameType;                                       // 0x1028(0x0001) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x1029(0x0003) MISSED OFFSET
	int                                                CreativeModID;                                            // 0x102C(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	int                                                CreativeModTemplateId;                                    // 0x1030(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	class UCreativeModeGameStateBaseComponent*         CurrentStateComponent;                                    // 0x1034(0x0004) (Net, ZeroConstructor, Transient, IsPlainOldData)
	class UCreativeModeGameStateBaseComponent*         LastStateComponent;                                       // 0x1038(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	TArray<class UClass*>                              GameStateComponentClassArray;                             // 0x103C(0x000C) (ZeroConstructor, Transient)
	class UClass*                                      GameStateComponentClass;                                  // 0x1048(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bIsCreativeWoW;                                           // 0x104C(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x13];                                      // 0x104D(0x0013) MISSED OFFSET
	TArray<struct FBlockySlotString>                   BlockySlotStrings;                                        // 0x1060(0x000C) (Net, ZeroConstructor, Transient)
	struct FGameStateLiteComponentTickFunction         LiteComponentActorTick;                                   // 0x106C(0x003C) (Edit, DisableEditOnInstance)
	TArray<class ULiteComponent*>                      LiteComponents;                                           // 0x10A8(0x000C) (ZeroConstructor, Transient)
...
{
public:
	bool                                               bEnableAutoPickUp;                                        // 0x16A0(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x16A1(0x0007) MISSED OFFSET
