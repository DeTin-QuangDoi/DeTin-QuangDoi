...
public:
	...
	TEnumAsByte<EPhotonDestructibleAction>             DestructibleAction;                                       // 0x016C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UseDefaultParameter : 1;                                  // 0x016D(0x0001) (Edit)
	TEnumAsByte<EPhotonCollisionType>                  FragmentCollisonType;                                     // 0x016E(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x1];                                       // 0x016F(0x0001) MISSED OFFSET
	struct FPhotonDestructibleMeshPhysicsDetachData    PhysicsDetachData;                                        // 0x0170(0x0024) (Edit)
	unsigned char                                      UnknownData01[0x7C];                                      // 0x0194(0x007C) MISSED OFFSET
...
{
public:
	unsigned char                                      DestructibleMeshActorReplication : 1;                     // 0x0448(0x0001) (Edit, BlueprintVisible)
