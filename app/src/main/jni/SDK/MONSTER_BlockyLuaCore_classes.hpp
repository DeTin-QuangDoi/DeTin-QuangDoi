...
{
public:
	unsigned char                                      UnknownData00[0x110];                                     // 0x0178(0x0110) MISSED OFFSET
	TMap<struct FString, struct FBlockParam>           BlockParams;                                              // 0x0288(0x0050) (BlueprintVisible, ZeroConstructor)
	TArray<class UNamedVar*>                           FuncVars;                                                 // 0x02C4(0x000C) (BlueprintVisible, ZeroConstructor)
...
{
public:
	unsigned char                                      UnknownData00[0x1D8];                                     // 0x02D8(0x01D8) MISSED OFFSET
...
// 0x0310 (0x0488 - 0x0178)
class UArithmetic : public UBlockBase
{
public:
	unsigned char                                      UnknownData00[0x310];                                     // 0x0178(0x0310) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0xEC];                                      // 0x0178(0x00EC) MISSED OFFSET
	class UBrushData*                                  BrushBGSelected;                                          // 0x0264(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData01[0x144];                                     // 0x01A0(0x0144) MISSED OFFSET
	bool                                               bIsArray;                                                 // 0x02E4(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x02E5(0x0003) MISSED OFFSET
	struct FString                                     InitValueString;                                          // 0x02E8(0x000C) (ZeroConstructor)
	class UColorDesc*                                  ColorDesc;                                                // 0x02F4(0x0004) (ZeroConstructor, IsPlainOldData)
	class UNamedVar*                                   Source;                                                   // 0x02F8(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData03[0x40];                                      // 0x02FC(0x0040) MISSED OFFSET
	class UBrushData*                                  CopyBrush;                                                // 0x033C(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	...
	bool IsCustomColor();
	bool IsArray();
	class UColorDesc* GetNameVarColorDesc();
	struct FLinearColor GetNameVarColor();
	struct FString GetInitValueString();
	class UVarDefiner* GetDefiner();
	struct FString GetColorStr();
	TEnumAsByte<EBlockyAccessType> GetAccessType();
	void CallCustomSelectObject();
};
...
public:
	...
	unsigned char                                      UnknownData00[0x13C];                                     // 0x00A4(0x013C) MISSED OFFSET
...
public:
	...
	class UBlockyGraph*                                SavedGraph;                                               // 0x002C(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0030(0x0008) MISSED OFFSET
	struct FBlockPoint                                 ViewSize;                                                 // 0x0038(0x0008) (BlueprintVisible)
	float                                              ViewScale;                                                // 0x0040(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0044(0x0004) MISSED OFFSET
	struct FVector2D                                   DisplayBlockSize;                                         // 0x0048(0x0008) (IsPlainOldData)
	unsigned char                                      UnknownData03[0x74];                                      // 0x0050(0x0074) MISSED OFFSET
	...
	unsigned char                                      UnknownData05[0x14];                                      // 0x0154(0x0014) MISSED OFFSET
	...
	unsigned char                                      UnknownData06[0x4];                                       // 0x0170(0x0004) MISSED OFFSET
	...
	unsigned char                                      UnknownData07[0xA];                                       // 0x0192(0x000A) MISSED OFFSET
	...
	unsigned char                                      UnknownData08[0x1C];                                      // 0x01C4(0x001C) MISSED OFFSET
	class UBlockBase*                                  TouchBlockHostSlotHost;                                   // 0x01E0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0xAC];                                      // 0x01E4(0x00AC) MISSED OFFSET
	...
	unsigned char                                      UnknownData11[0x1];                                       // 0x0430(0x0001) MISSED OFFSET
	bool                                               IsOpenedCaption;                                          // 0x0431(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0xE];                                       // 0x0432(0x000E) MISSED OFFSET
...
public:
	...
	float                                              HookupSlotWidth;                                          // 0x02CC(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              HookupSlotHeight;                                         // 0x02D0(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              HookupChildIndentation;                                   // 0x02D4(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              HookupLinkWidth;                                          // 0x02D8(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	struct FVector2D                                   CommentButtonSize;                                        // 0x02DC(0x0008) (Edit, Config, IsPlainOldData)
	struct FVector2D                                   CommentTextSize;                                          // 0x02E4(0x0008) (Edit, Config, IsPlainOldData)
	struct FVector2D                                   CommentFlodSize;                                          // 0x02EC(0x0008) (Edit, Config, IsPlainOldData)
	struct FVector2D                                   CommentTitleSize;                                         // 0x02F4(0x0008) (Edit, Config, IsPlainOldData)
	float                                              CommentLineLen;                                           // 0x02FC(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	int                                                CommentBlinkCount;                                        // 0x0300(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              CommentBlinkSpeed;                                        // 0x0304(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              BlockListWidth;                                           // 0x0308(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	struct FMargin                                     ListBlockSelectedIconPadding;                             // 0x030C(0x0010) (Edit, Config, IsPlainOldData)
	float                                              ListBlockSelectedIconSize;                                // 0x031C(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              NextCategoryOffset;                                       // 0x0320(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              DeleteBlocksYOffset;                                      // 0x0324(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	struct FVector2D                                   DeleteBlocksSize;                                         // 0x0328(0x0008) (Edit, Config, IsPlainOldData)
	struct FVector2D                                   CanDeleteSize;                                            // 0x0330(0x0008) (Edit, Config, IsPlainOldData)
	struct FVector2D                                   BlockEmblemSize;                                          // 0x0338(0x0008) (Edit, Config, IsPlainOldData)
	float                                              DisplayViewMaxBlockWidth;                                 // 0x0340(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	struct FLinearColor                                DefaultBackColor;                                         // 0x0344(0x0010) (Edit, Config, IsPlainOldData)
	struct FLinearColor                                DarkBackColor;                                            // 0x0354(0x0010) (Edit, Config, IsPlainOldData)
	struct FLinearColor                                KeyWordColor;                                             // 0x0364(0x0010) (Edit, Config, IsPlainOldData)
	struct FLinearColor                                IllegalWordColor;                                         // 0x0374(0x0010) (Edit, Config, IsPlainOldData)
	struct FLinearColor                                FunctionBackColor;                                        // 0x0384(0x0010) (Edit, Config, IsPlainOldData)
	float                                              BlockSnapAreaLeft;                                        // 0x0394(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              BlockSnapAreaTop;                                         // 0x0398(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              BlockSnapAreaWidth;                                       // 0x039C(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              BlockSnapAreaHeight;                                      // 0x03A0(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	struct FString                                     PreViewMaterial;                                          // 0x03A4(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     LocalizationNameSpace;                                    // 0x03B0(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     DefaultRect;                                              // 0x03BC(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     ActionRect;                                               // 0x03C8(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     ActionRectSelected;                                       // 0x03D4(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     ValueRect;                                                // 0x03E0(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     ValueDisableRect;                                         // 0x03EC(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     ValueSelectDisableRect;                                   // 0x03F8(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     BoolBlock;                                                // 0x0404(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     BoolBlockEmpty;                                           // 0x0410(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     BoolBlockSelect;                                          // 0x041C(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     BoolBlockDisable;                                         // 0x0428(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     NumBlockEmpty;                                            // 0x0434(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     NumBlockSelect;                                           // 0x0440(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     NumBlockDisable;                                          // 0x044C(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     DeleteBlocksRect;                                         // 0x0458(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     SnapShowRect;                                             // 0x0464(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     ListItemSelected;                                         // 0x0470(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     SingleVarRect;                                            // 0x047C(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     ArrayVarRect;                                             // 0x0488(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     CallbackVarRect;                                          // 0x0494(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     VarRectDisable;                                           // 0x04A0(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     VarOutline;                                               // 0x04AC(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     GlobalVarIcon;                                            // 0x04B8(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     CanvasVarIcon;                                            // 0x04C4(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     LocalVarIcon;                                             // 0x04D0(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     CallbackVarIcon;                                          // 0x04DC(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     CustomIcon;                                               // 0x04E8(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     CustomActionBG;                                           // 0x04F4(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     CustomActionBG_Selected;                                  // 0x0500(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     CustomActionBG_Gray;                                      // 0x050C(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     CustomActionBG_Gray_Selected;                             // 0x0518(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     CustomValueBG;                                            // 0x0524(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     CustomValueBG_Selected;                                   // 0x0530(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     CustomValueBG_Gray;                                       // 0x053C(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     CustomValueBG_Gray_Selected;                              // 0x0548(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     CustomEventBG;                                            // 0x0554(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     CustomEventBG_Selected;                                   // 0x0560(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     CustomEventBG_Gray;                                       // 0x056C(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     CustomEventBG_Gray_Selected;                              // 0x0578(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     CustomBlock_Emblem;                                       // 0x0584(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     CustomBlock_Emblem_Selected;                              // 0x0590(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     CustomBlock_Emblem_Disable;                               // 0x059C(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     CustomBlock_Emblem_DisableSelected;                       // 0x05A8(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     EventBlock_Emblem;                                        // 0x05B4(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     EventBlock_Emblem_Selected;                               // 0x05C0(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     EventBlock_Emblem_Disable;                                // 0x05CC(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     EventBlock_Emblem_DisableSelected;                        // 0x05D8(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     LogicUp;                                                  // 0x05E4(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     LogicUpSelected;                                          // 0x05F0(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     LogicUpGray;                                              // 0x05FC(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     LogicUpSelectedGray;                                      // 0x0608(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     LogicMiddle;                                              // 0x0614(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     LogicMiddleSelected;                                      // 0x0620(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     LogicBottom;                                              // 0x062C(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     LogicBottomGray;                                          // 0x0638(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     LogicBottomSelected;                                      // 0x0644(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     LogicBottomSelectedGray;                                  // 0x0650(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     LogicSlot;                                                // 0x065C(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     LogicSlotGray;                                            // 0x0668(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     LogicSlotSelected;                                        // 0x0674(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     LogicSlotSelectedGray;                                    // 0x0680(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     HookupSlot;                                               // 0x068C(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     ButtonWithTextBg_Enable;                                  // 0x0698(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     ButtonWithTextBg_Selected;                                // 0x06A4(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     ButtonWithTextBg_Disable;                                 // 0x06B0(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     ButtonWithTextBg_DisableSelected;                         // 0x06BC(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     SlotTriangle;                                             // 0x06C8(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     SlotWarring;                                              // 0x06D4(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     SlotForbidden;                                            // 0x06E0(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     SlotIllegalInput;                                         // 0x06EC(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     FunctionIcon;                                             // 0x06F8(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     SettingIcon;                                              // 0x0704(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     ColorIcon;                                                // 0x0710(0x000C) (Edit, ZeroConstructor, Config)
	TArray<struct FLinearColor>                        DefaultHSVs;                                              // 0x071C(0x000C) (ZeroConstructor)
	struct FString                                     CopyIcon;                                                 // 0x0728(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     CommentIcon;                                              // 0x0734(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     FlodIcon;                                                 // 0x0740(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     UnbindIcon;                                               // 0x074C(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     SeparatorIcon;                                            // 0x0758(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     NoneIcon;                                                 // 0x0764(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     DefaultCategoryIcon;                                      // 0x0770(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     DefaultCategorySelectedIcon;                              // 0x077C(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     BlockyGlobalVarPath;                                      // 0x0788(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     BlockyGraphPath;                                          // 0x0794(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     GenerateCodePath;                                         // 0x07A0(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     AssetPackageName;                                         // 0x07AC(0x000C) (Edit, ZeroConstructor, Config)
	int                                                UndoMaxSteps;                                             // 0x07B8(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	int                                                MaxStoredNumOfSearchHistory;                              // 0x07BC(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	bool                                               SearchUseCase;                                            // 0x07C0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData08[0x3];                                       // 0x07C1(0x0003) MISSED OFFSET
	struct FLinearColor                                SearchedKeyWordColor;                                     // 0x07C4(0x0010) (Edit, Config, IsPlainOldData)
	int                                                MaxTemplateDescriptionLen;                                // 0x07D4(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              SaveCooldownDuration;                                     // 0x07D8(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	TMap<struct FString, class UBrushData*>            BlockyBrushDatas;                                         // 0x07DC(0x0050) (ZeroConstructor)
	TMap<struct FString, struct FBlockyBrushInfo>      BlockyBrushInfos;                                         // 0x0818(0x0050) (ZeroConstructor)
	TMap<struct FString, struct FString>               RTLBrushMap;                                              // 0x0854(0x0050) (ZeroConstructor)
	TArray<struct FString>                             BlockyBrushNames;                                         // 0x0890(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData09[0x78];                                      // 0x089C(0x0078) MISSED OFFSET
	TMap<struct FString, class UFunctionDesc*>         Functions;                                                // 0x0914(0x0050) (ZeroConstructor)
	TMap<struct FString, class UFunctionDesc*>         FuncTemplates;                                            // 0x0950(0x0050) (ZeroConstructor)
	TMap<struct FString, class UFunctionDesc*>         TypeFilterFunctions;                                      // 0x098C(0x0050) (ZeroConstructor)
	TArray<class UBlackboardDefiner*>                  BlackboardDefiners;                                       // 0x09C8(0x000C) (ZeroConstructor)
	TMap<struct FString, class UVarDefiner*>           VarDefiners;                                              // 0x09D4(0x0050) (ZeroConstructor)
	TMap<struct FString, class UCustomDefiner*>        CustomDefiners;                                           // 0x0A10(0x0050) (ZeroConstructor)
	TMap<struct FString, class UCategoryDefiner*>      CategoryDefiners;                                         // 0x0A4C(0x0050) (ZeroConstructor)
	TMap<struct FString, class UEnumDesc*>             Enums;                                                    // 0x0A88(0x0050) (ZeroConstructor)
	TArray<class UBlockyMenuItemObject*>               MenuItems;                                                // 0x0AC4(0x000C) (ZeroConstructor)
	TMap<struct FString, class UTypeConvertDesc*>      TypeConverts;                                             // 0x0AD0(0x0050) (ZeroConstructor)
	TMap<struct FString, class UPresetDesc*>           PresetDescMap;                                            // 0x0B0C(0x0050) (ZeroConstructor)
	TMap<struct FString, class UPresetDesc*>           CodeNameAndTypeKeyPresetDescMap;                          // 0x0B48(0x0050) (ZeroConstructor)
	TArray<class UBlockyMenuItemObject*>               PresetMenuItems;                                          // 0x0B84(0x000C) (ZeroConstructor)
	TArray<class UBlockyGraph*>                        TemplateGraphs;                                           // 0x0B90(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData10[0x3C];                                      // 0x0B9C(0x003C) UNKNOWN PROPERTY: SetProperty BlockyLuaCore.BlockyLuaConfig.AllTypes
	TMap<struct FString, struct FString>               TipsMap;                                                  // 0x0BD8(0x0050) (ZeroConstructor)
	TArray<struct FString>                             MenuSequence;                                             // 0x0C14(0x000C) (ZeroConstructor)
	TMap<struct FString, struct FSequence>             CategorySequence;                                         // 0x0C20(0x0050) (ZeroConstructor)
	TMap<struct FString, struct FSequence>             ItemSequence;                                             // 0x0C5C(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData11[0x18];                                      // 0x0C98(0x0018) MISSED OFFSET
	struct FSlateFontInfo                              FontInfo;                                                 // 0x0CB0(0x0040)
	unsigned char                                      UnknownData12[0x4];                                       // 0x0CF0(0x0004) MISSED OFFSET
	TMap<struct FString, class UVarDefiner*>           AllTypesMap;                                              // 0x0CF4(0x0050) (ZeroConstructor)
	TMap<struct FGuid, struct FScriptDelegate>         OnReceiveCheckStringResults;                              // 0x0D30(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData13[0x4];                                       // 0x0D6C(0x0004) MISSED OFFSET
	struct FScriptDelegate                             OnGetLocaleString;                                        // 0x0D70(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnCallCustomSelectObject;                                 // 0x0D80(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnReceiveCustomSelectObject;                              // 0x0D90(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnCheckShowCustomSelection;                               // 0x0DA0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnModifyTip;                                              // 0x0DB0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnAddBlockyLog;                                           // 0x0DC0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnGetValidString;                                         // 0x0DD0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnCheckStringValid;                                       // 0x0DE0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnMessageData;                                            // 0x0DF0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnIsCurrentCultureLTR;                                    // 0x0E00(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnGetTextLen;                                             // 0x0E10(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnPlayPresetSound;                                        // 0x0E20(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnOpenGuide;                                              // 0x0E30(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData14[0x78];                                      // 0x0E40(0x0078) MISSED OFFSET
...
{
public:
	class UBrushData*                                  TailBrush;                                                // 0x02D8(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData00[0x13C];                                     // 0x02DC(0x013C) MISSED OFFSET
...
// 0x03B8 (0x07D0 - 0x0418)
class UBlockyTimer : public UExeSequencerBase
{
public:
	unsigned char                                      UnknownData00[0x3B4];                                     // 0x0418(0x03B4) MISSED OFFSET
	class UBrushData*                                  IconBrush;                                                // 0x07CC(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	class UBrushData*                                  IconBrush;                                                // 0x02F0(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	class UBrushData*                                  SelectionBG;                                              // 0x02F4(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData02[0x141];                                     // 0x0077(0x0141) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0xD8];                                      // 0x02D8(0x00D8) MISSED OFFSET
	class UBlockBase*                                  CandidateParentBlock;                                     // 0x03B0(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
...
// 0x0200 (0x0618 - 0x0418)
class UCreateSubDefineFunction : public UExeSequencerBase
{
public:
	unsigned char                                      UnknownData00[0x1FC];                                     // 0x0418(0x01FC) MISSED OFFSET
	class UBrushData*                                  IconBrush;                                                // 0x0614(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
...
{
public:
	class UCustomConfig*                               Config;                                                   // 0x02D8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FGuid                                       ConfigName;                                               // 0x02DC(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	class UBrushData*                                  BrushBGSelected;                                          // 0x02EC(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	class UBrushData*                                  IconBrush;                                                // 0x02F0(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	class UBrushData*                                  BrushBG;                                                  // 0x02F4(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	class UCustomConfig*                               Config;                                                   // 0x0428(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FGuid                                       ConfigName;                                               // 0x042C(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	class UBrushData*                                  IconBrush;                                                // 0x043C(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	class UBrushData*                                  BrushBG;                                                  // 0x0440(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
...
{
public:
	struct FString                                     TemplateFunc;                                             // 0x0088(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	struct FString                                     TemplateImplFunc;                                         // 0x0094(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
...
{
public:
	class UCustomConfig*                               Config;                                                   // 0x0310(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FGuid                                       ConfigName;                                               // 0x0314(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	class UBrushData*                                  IconBrush;                                                // 0x0324(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	class UBrushData*                                  BrushBG;                                                  // 0x0328(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3C];                                      // 0x032C(0x003C) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0xFC];                                      // 0x0418(0x00FC) MISSED OFFSET
	class UCustomConfig*                               Config;                                                   // 0x0514(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FGuid                                       ConfigName;                                               // 0x0518(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	class UBrushData*                                  IconBrush;                                                // 0x0528(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	class UBrushData*                                  BrushBG;                                                  // 0x052C(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
...
// 0x01E0 (0x05F8 - 0x0418)
class UDoNum : public UExeSequencerBase
{
public:
	unsigned char                                      UnknownData00[0x1D8];                                     // 0x0418(0x01D8) MISSED OFFSET
	class UBrushData*                                  IconBrush;                                                // 0x05F0(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	class UBrushData*                                  DisableIconBrush;                                         // 0x02E0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x1C];                                      // 0x02E4(0x001C) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x2DC];                                     // 0x0418(0x02DC) MISSED OFFSET
	class UBrushData*                                  IconBrush;                                                // 0x06F4(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	unsigned char                                      UnknownData00[0xC];                                       // 0x001C(0x000C) MISSED OFFSET
	struct FString                                     CodeName;                                                 // 0x0028(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	unsigned char                                      UnknownData01[0x30];                                      // 0x0034(0x0030) MISSED OFFSET
	struct FString                                     Host;                                                     // 0x0064(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	struct FString                                     Description;                                              // 0x0070(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	unsigned char                                      UnknownData02[0x34];                                      // 0x007C(0x0034) MISSED OFFSET
	class UClass*                                      BlockClass;                                               // 0x00B0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x8];                                       // 0x00B4(0x0008) MISSED OFFSET
	TArray<struct FFunctionParameter>                  Parameters;                                               // 0x00BC(0x000C) (ZeroConstructor)
	TArray<struct FFunctionParameter>                  AddEventParameters;                                       // 0x00C8(0x000C) (ZeroConstructor)
	TMap<struct FString, struct FString>               ModuleRequires;                                           // 0x00D4(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData04[0x50];                                      // 0x0110(0x0050) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0xF8];                                      // 0x0178(0x00F8) MISSED OFFSET
	class UBrushData*                                  BrushBGSelected;                                          // 0x0270(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
...
{
public:
	TArray<class UIfElseCondition*>                    ElseConditions;                                           // 0x02D8(0x000C) (ZeroConstructor)
...
{
public:
	class UIfElse*                                     ParentIfElse;                                             // 0x0418(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData00[0x12C];                                     // 0x041C(0x012C) MISSED OFFSET
...
// 0x01E0 (0x0360 - 0x0180)
class ULogicAnd : public ULogicBase
{
public:
	unsigned char                                      UnknownData00[0x1E0];                                     // 0x0180(0x01E0) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x2C0];                                     // 0x0180(0x02C0) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0xE8];                                      // 0x0180(0x00E8) MISSED OFFSET
...
// 0x04B0 (0x08C8 - 0x0418)
class UNumFromTo : public UExeSequencerBase
{
public:
	unsigned char                                      UnknownData00[0x4AC];                                     // 0x0418(0x04AC) MISSED OFFSET
	class UBrushData*                                  IconBrush;                                                // 0x08C4(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
...
{
public:
	unsigned char                                      UnknownData00[0x100];                                     // 0x02D8(0x0100) MISSED OFFSET
...
public:
	...
	struct FString                                     Name;                                                     // 0x0028(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	struct FString                                     CodeName;                                                 // 0x0034(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	struct FString                                     Icon;                                                     // 0x0040(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	struct FText                                       Menu;                                                     // 0x004C(0x000C) (Edit, BlueprintVisible)
	struct FText                                       Category;                                                 // 0x0058(0x000C) (Edit, BlueprintVisible)
	struct FString                                     AnimationPath;                                            // 0x0064(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	struct FString                                     SoundPath;                                                // 0x0070(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	bool                                               IsSelected;                                               // 0x007C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0xB];                                       // 0x007D(0x000B) MISSED OFFSET
	bool                                               Visible;                                                  // 0x0088(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               Removed;                                                  // 0x0089(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               Localed;                                                  // 0x008A(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x13D];                                     // 0x008B(0x013D) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x1D4];                                     // 0x02D8(0x01D4) MISSED OFFSET
	class UBrushData*                                  IconBrush;                                                // 0x04AC(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	class UBrushData*                                  SelectionBG;                                              // 0x04B0(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
...
{
public:
	unsigned char                                      UnknownData00[0x1E8];                                     // 0x0178(0x01E8) MISSED OFFSET
...
public:
	unsigned char                                      UnknownData00[0x14];                                      // 0x001C(0x0014) MISSED OFFSET
	class UFunctionDesc*                               FunctionDesc;                                             // 0x0030(0x0004) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	TMap<struct FString, struct FString>               ShowNameMap;                                              // 0x0074(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
	struct FString                                     ShowIcon;                                                 // 0x00B0(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	struct FString                                     ShowIconSelected;                                         // 0x00BC(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	struct FString                                     DefaultValueString;                                       // 0x00C8(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	bool                                               bHideInCustom;                                            // 0x00D4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBlockyVarInitType>                    InitType;                                                 // 0x00D5(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x00D6(0x0002) MISSED OFFSET
	TArray<struct FString>                             ExcludePresetCategories;                                  // 0x00D8(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<struct FString>                             ExcludePresetCodeNames;                                   // 0x00E4(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
...
{
public:
	unsigned char                                      UnknownData00[0xEC];                                      // 0x0418(0x00EC) MISSED OFFSET
	class UBrushData*                                  IconBrush;                                                // 0x0504(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
