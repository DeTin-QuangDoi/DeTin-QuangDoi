...
struct FDiffAIPlayerStateBaseMod : public FDiffStateInfoBase
{
	...
	unsigned char                                      UnknownData08[0x7];                                       // 0x00E9(0x0007) MISSED OFFSET
};
...
// 0x0310 (0x0328 - 0x0018)
struct FDiffAIStateInfoBaseMod : public FDiffStateInfoBase
{
	struct FDiffAIPlayerStateBaseMod                   State;                                                    // 0x0018(0x00F0)
	...
	struct FAIPlayerInteractInfo                       player_interact_info;                                     // 0x01D8(0x0048)
	struct FAIHeardSound                               Sound;                                                    // 0x0220(0x000C)
	TArray<struct FDamageSource>                       all_damage_source;                                        // 0x022C(0x000C) (ZeroConstructor)
	struct FDiffProgressBarState                       progress_bar;                                             // 0x0238(0x0020)
	struct FDiffAINearbyPlayersBaseMod                 nearby_player;                                            // 0x0258(0x0030)
	struct FDiffItemStateDatas                         nearby_item;                                              // 0x0288(0x0030)
	TArray<struct FAINearbyThrown>                     nearby_thrown;                                            // 0x02B8(0x000C) (ZeroConstructor)
	TArray<struct FItemStateData>                      nearby_box_item;                                          // 0x02C4(0x000C) (ZeroConstructor)
	struct FAIPlayerHitInfo                            player_hit_info;                                          // 0x02D0(0x0028)
	TArray<struct FAIBulletHole>                       all_bullet_hole;                                          // 0x02F8(0x000C) (ZeroConstructor)
	uint32_t                                           ai_style;                                                 // 0x0304(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FDiffAIConfig                               Config;                                                   // 0x0308(0x0020)
};
...
{
	struct FAIPlayerStateBRBase                        State;                                                    // 0x0020(0x0058)
	struct FVehicleState                               vehicle_state;                                            // 0x0078(0x00C8)
	TArray<struct FDoorState>                          nearby_door;                                              // 0x0140(0x000C) (ZeroConstructor)
	TArray<struct FVehicleState>                       nearby_vehicles;                                          // 0x014C(0x000C) (ZeroConstructor)
	TArray<struct FAIRecipients>                       recipients;                                               // 0x0158(0x000C) (ZeroConstructor)
	TArray<struct FMonsterState>                       monster_states;                                           // 0x0164(0x000C) (ZeroConstructor)
	TArray<struct FDynamicItem>                        dynamic_items;                                            // 0x0170(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   nearby_door_index;                                        // 0x017C(0x000C) (ZeroConstructor)
	uint32_t                                           deliver_target_id;                                        // 0x0188(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<uint64_t>                                   nearby_vehicles_index;                                    // 0x018C(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   dynamic_items_index;                                      // 0x0198(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   monster_states_index;                                     // 0x01A4(0x000C) (ZeroConstructor)
	TArray<struct FLandScapeDestroyState>              landscape_destroy_info;                                   // 0x01B0(0x000C) (ZeroConstructor)
...
{
	struct FAIPlayerStateBRBase                        State;                                                    // 0x0020(0x0058)
	struct FDiffDoorStateGeneral                       nearby_door;                                              // 0x0078(0x0030)
	TArray<uint64_t>                                   nearby_door_index;                                        // 0x00A8(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x00B4(0x0004) MISSED OFFSET
	struct FVehicleState                               vehicle_state;                                            // 0x00B8(0x00C8)
	struct FDiffVehicleStatesGeneral                   nearby_vehicles;                                          // 0x0180(0x0030)
	TArray<uint64_t>                                   nearby_vehicles_index;                                    // 0x01B0(0x000C) (ZeroConstructor)
	uint32_t                                           deliver_target_id;                                        // 0x01BC(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FAIRecipients>                       recipients;                                               // 0x01C0(0x000C) (ZeroConstructor)
	...
	TArray<uint64_t>                                   dynamic_items_index;                                      // 0x0200(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x4];                                       // 0x020C(0x0004) MISSED OFFSET
	struct FDiffMonsterStatesGeneral                   monster_states;                                           // 0x0210(0x0030)
	TArray<uint64_t>                                   monster_states_index;                                     // 0x0240(0x000C) (ZeroConstructor)
...
{
	struct FDiffAIPlayerStateBRBase                    State;                                                    // 0x0018(0x0050)
	struct FDiffVehicleState                           vehicle_state;                                            // 0x0068(0x0090)
	TArray<struct FDoorState>                          nearby_door;                                              // 0x00F8(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0104(0x0004) MISSED OFFSET
	struct FDiffVehicleStates                          nearby_vehicles;                                          // 0x0108(0x0030)
	TArray<struct FAIRecipients>                       recipients;                                               // 0x0138(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0144(0x0004) MISSED OFFSET
	struct FDiffMonsterStates                          monster_states;                                           // 0x0148(0x0030)
	struct FDiffDynamicItemStates                      dynamic_item_states;                                      // 0x0178(0x0030)
	struct FDiffLandScapeDestroyStateInfo              landscape_destroy_info;                                   // 0x01A8(0x0030)
};
...
struct FDiffAIBaseStateInfo : public FDiffStateInfoBase
{
	...
	struct FDiffAIPlayerEquipment                      equipment;                                                // 0x01A0(0x0030)
	uint32_t                                           Key;                                                      // 0x01D0(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           ai_style;                                                 // 0x01D4(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FAIPlayerInteractInfo                       player_interact_info;                                     // 0x01D8(0x0048)
};
...
{
	struct FAIPlayerBRBaseState                        State;                                                    // 0x0020(0x0050)
	uint32_t                                           deliver_target_id;                                        // 0x0070(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FAIRecipients>                       recipients;                                               // 0x0074(0x000C) (ZeroConstructor)
};
...
{
	struct FDiffAIPlayerBRBaseState                    State;                                                    // 0x0018(0x0048)
...
struct FDiffAllPlayerBRBaseInfo : public FAIStateInfoBase
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x008C(0x0004) MISSED OFFSET
	struct FGlobalGameBRBaseState                      global_state;                                             // 0x0090(0x00D8)
	struct FDiffGlobalGameBRBaseState                  diff_global_state;                                        // 0x0168(0x0120)
	TMap<uint32_t, struct FAIBRBaseStateInfo>          global_player_states;                                     // 0x0288(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDiffAIBRBaseStateInfo>      global_player_diff_states;                                // 0x02C4(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIBRBaseStateInfo>          near_player_states;                                       // 0x0300(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDiffAIBRBaseStateInfo>      near_player_diff_states;                                  // 0x033C(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIBRBaseStateInfo>          global_btai_states;                                       // 0x0378(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDiffAIBRBaseStateInfo>      global_btai_diff_states;                                  // 0x03B4(0x0050) (ZeroConstructor)
};
...
struct FDiffAllPlayerInfoBRBase : public FAIStateInfoBase
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
	struct FGlobalGameStateBRBase                      global_state;                                             // 0x0030(0x0138)
	struct FDiffGlobalGameStateBRBase                  diff_global_state;                                        // 0x0168(0x0120)
	TArray<struct FAIStateInfoBRBase>                  global_player_states;                                     // 0x0288(0x000C) (ZeroConstructor)
	TArray<struct FDiffBTAIAndPlayerStateInfoBRBase>   global_player_diff_states;                                // 0x0294(0x000C) (ZeroConstructor)
	TArray<struct FAIStateInfoBRBase>                  near_player_states;                                       // 0x02A0(0x000C) (ZeroConstructor)
	TArray<struct FDiffBTAIAndPlayerStateInfoBRBase>   near_player_diff_states;                                  // 0x02AC(0x000C) (ZeroConstructor)
	TArray<struct FAIStateInfoBRBase>                  global_btai_states;                                       // 0x02B8(0x000C) (ZeroConstructor)
	TArray<struct FDiffBTAIAndPlayerStateInfoBRBase>   global_btai_diff_states;                                  // 0x02C4(0x000C) (ZeroConstructor)
};
