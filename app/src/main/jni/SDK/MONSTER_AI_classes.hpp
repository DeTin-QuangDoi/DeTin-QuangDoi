...
public:
	...
	struct FDiffAIStateInfoBaseMod                     CacheDiffAIStateInfoBaseMod;                              // 0x0DA8(0x0328)
	bool                                               IsTouchedPlayer;                                          // 0x10D0(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x10D1(0x0003) MISSED OFFSET
	uint32_t                                           FrameNo;                                                  // 0x10D4(0x0004) (ZeroConstructor, IsPlainOldData)
	class ASTExtraPlayerController*                    MyPlayerController;                                       // 0x10D8(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SkipFrameConfig;                                          // 0x10DC(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SkipFrameConfigSecond;                                    // 0x10E0(0x0004) (ZeroConstructor, IsPlainOldData)
	class AController*                                 OwnerController;                                          // 0x10E4(0x0004) (ZeroConstructor, IsPlainOldData)
	class ANewFakePlayerAIController*                  MyAIController;                                           // 0x10E8(0x0004) (ZeroConstructor, IsPlainOldData)
	class UAIActingComponent*                          AIActingComp;                                             // 0x10EC(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class APawn*                                       MyOwnerPawn;                                              // 0x10F0(0x0004) (ZeroConstructor, IsPlainOldData)
	class ABattleRoyaleGameModeBase*                   MyGameMode;                                               // 0x10F4(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x38];                                      // 0x10F8(0x0038) MISSED OFFSET
	TArray<struct FDamageSource>                       DamageSourcesInfoNew;                                     // 0x1130(0x000C) (ZeroConstructor)
	TMap<int, class APickUpWrapperActor*>              CacheAINearbyItem;                                        // 0x113C(0x0050) (ZeroConstructor)
	TArray<class ASTExtraBaseCharacter*>               CacheNearbyEnemies;                                       // 0x1178(0x000C) (ZeroConstructor)
	struct FCacheNearbyItemState                       CacheNearbyItemState;                                     // 0x1184(0x001C)
	class UMLAIControllerComponent*                    MyMLAIControllerComp;                                     // 0x11A0(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	uint32_t                                           CacheModeMapId;                                           // 0x11A4(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0xC];                                       // 0x11A8(0x000C) MISSED OFFSET
	class UMLAISubSystem*                              MLAISubSystem;                                            // 0x11B4(0x0004) (ZeroConstructor, IsPlainOldData)
	class UMLAIUtilsBase*                              MLAIUtils;                                                // 0x11B8(0x0004) (ZeroConstructor, IsPlainOldData)
	class UAIStateInfoDataAsset*                       AIStateInfoDataAsset;                                     // 0x11BC(0x0004) (ZeroConstructor, IsPlainOldData)
	class AAIWorldVolume*                              AIWorldVolume;                                            // 0x11C0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x14];                                      // 0x11C4(0x0014) MISSED OFFSET
...
// 0x07B8 (0x1990 - 0x11D8)
class UAIStateInfoComponentBRBase : public UAIStateInfoComponentBase
{
public:
	struct FAIStateInfoBRBase                          CacheAIStateInfoBRBase;                                   // 0x11D8(0x01C0)
	struct FAIStateInfoBRBase                          LastAIStateInfoBRBase;                                    // 0x1398(0x01C0)
	struct FDiffAIStateInfoBRBaseGeneral               CacheDiffAIStateInfoBRBaseGeneral;                        // 0x1558(0x0250)
	struct FDiffAIStateInfoBRBase                      CacheDiffAIStateInfoBRBase;                               // 0x17A8(0x01D8)
	class UMLAIUtilsBRBase*                            MLAIUtilsBR;                                              // 0x1980(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0xC];                                       // 0x1984(0x000C) MISSED OFFSET
...
// 0x01F0 (0x13C8 - 0x11D8)
class UAIStateInfoComponentMPBase : public UAIStateInfoComponentBase
{
public:
	struct FAIStateInfoMPBase                          CacheAIStateInfoMPBase;                                   // 0x11D8(0x00A0)
	struct FAIStateInfoMPBase                          LastAIStateInfoMPBase;                                    // 0x1278(0x00A0)
	struct FDiffAIStateInfoMPBaseGeneral               CacheDiffAIStateInfoMPBaseGeneral;                        // 0x1318(0x00B0)
...
// 0x00D8 (0x14A0 - 0x13C8)
class UAIStateInfoComponentTeamDeath : public UAIStateInfoComponentMPBase
{
public:
	struct FAIStateInfoTeamDeath                       CacheAIStateInfoTeamDeath;                                // 0x13C8(0x0048)
	struct FAIStateInfoTeamDeath                       LastAIStateInfoTeamDeath;                                 // 0x1410(0x0048)
	struct FDiffAIStateInfoTeamDeathGeneral            CacheDiffAIStateInfoTeamDeathGeneral;                     // 0x1458(0x0048)
...
public:
	...
	struct FDiffAllPlayerBRBaseInfo                    CacheAllPlayersInfoCSS;                                   // 0x01A8(0x03F0)
	struct FGlobalGameBRBaseState                      CacheGlobalGameState;                                     // 0x0598(0x00D8)
	struct FGlobalGameBRBaseState                      LastGlobalGameState;                                      // 0x0670(0x00D8)
	struct FDiffGlobalGameBRBaseState                  DiffGlobalGameState;                                      // 0x0748(0x0120)
	struct FDiffGlobalGameBRBaseStateGeneral           DiffGlobalGameStateGeneral;                               // 0x0868(0x0138)
	unsigned char                                      UnknownData01[0x18];                                      // 0x09A0(0x0018) MISSED OFFSET
...
public:
	...
	struct FGlobalGameStateBRBase                      GlobalGameState;                                          // 0x0220(0x0138)
	struct FGlobalGameStateBRBase                      LastGlobalGameState;                                      // 0x0358(0x0138)
	class UMLAIUtilsBase*                              MLAIUtils;                                                // 0x0490(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x54];                                      // 0x0494(0x0054) MISSED OFFSET
	TMap<uint32_t, int>                                CachePlayerRevivalTypes;                                  // 0x04E8(0x0050) (ZeroConstructor)
	class UMLAIStateInfoManager*                       MLAIStateInfoManager;                                     // 0x0524(0x0004) (ZeroConstructor, IsPlainOldData)
	TMap<uint32_t, struct FString>                     VoiceRoomInfoMap;                                         // 0x0528(0x0050) (ZeroConstructor)
	int                                                AirDropTag;                                               // 0x0564(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0568(0x0004) MISSED OFFSET
	float                                              ProduceSoundInterval;                                     // 0x056C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                nCanJumpToSky;                                            // 0x0570(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3C];                                      // 0x0574(0x003C) UNKNOWN PROPERTY: SetProperty AI.MLAISubSystem.TeammateMLAITeamIDSet
	unsigned char                                      UnknownData05[0x8];                                       // 0x05B0(0x0008) MISSED OFFSET
	TMap<class AActor*, class ASpecialZoneActor*>      CacheSpecialZoneParents;                                  // 0x05B8(0x0050) (ZeroConstructor)
	TArray<class ASpecialZoneActor*>                   CacheDynamicSpecialZone;                                  // 0x05F4(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData06[0x10];                                      // 0x0600(0x0010) MISSED OFFSET
	class ABattleRoyaleGameMode*                       CurGameMode;                                              // 0x0610(0x0004) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FGlobalGameStateBRBase                      CacheGlobalGameStateBRBase;                               // 0x0880(0x0138)
	struct FGlobalGameStateBRBase                      LastGlobalGameStateBRBase;                                // 0x09B8(0x0138)
	struct FDiffGlobalGameStateBRBase                  DiffGlobalGameStateBRBase;                                // 0x0AF0(0x0120)
	struct FDiffGlobalGameStateBRBaseGeneral           DiffGlobalGameStateBRBaseGeneral;                         // 0x0C10(0x0250)
	struct FRedZoneState                               CacheRedZoneInfo;                                         // 0x0E60(0x0030)
	TArray<struct FAIStateInfoBRBase>                  CacheAllPlayersInfoBRBase;                                // 0x0E90(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0E9C(0x0004) MISSED OFFSET
	struct FDiffAllPlayerInfoBRBaseGeneral             CacheDiffAllPlayersInfoBRBaseGeneral;                     // 0x0EA0(0x0078)
	struct FDiffAllPlayerInfoBRBase                    CacheAllPlayersInfoBRBaseCSS;                             // 0x0F18(0x02D0)
	TMap<uint32_t, struct FAIStateInfoBRBase>          LastAllPlayerInfoMapBRBase;                               // 0x11E8(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData03[0x2C];                                      // 0x1224(0x002C) MISSED OFFSET
	class UCircleMgrComponent*                         CircleMgr;                                                // 0x1250(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData04[0x14];                                      // 0x1254(0x0014) MISSED OFFSET
...
public:
	...
	class UPhotonInstancedDestructibleMeshComponent*   CacheDestructibleInstancedComp;                           // 0x03B0(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
