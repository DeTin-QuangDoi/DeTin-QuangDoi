...
public:
	...
	bool                                               bEnableSkillBlackboradIDSync;                             // 0x01B1(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableSkillNetBytesData;                                 // 0x01B2(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableSkillEncrypt;                                      // 0x01B3(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	class AActor*                                      OwnerActor;                                               // 0x01B4(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               DestroySkillsOnDie;                                       // 0x01B8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x01B9(0x0003) MISSED OFFSET
	TMap<int, TWeakObjectPtr<class AUTSkill>>          SkillIDToSkills;                                          // 0x01BC(0x0050) (ZeroConstructor, Transient)
	TMap<int, class UUAEBlackboard*>                   SkillIDBlackboardMap;                                     // 0x01F8(0x0050) (ZeroConstructor, Transient)
	TMap<TWeakObjectPtr<class AActor>, class UUAEBlackboard*> ActorBlackboardMap;                                       // 0x0234(0x0050) (ZeroConstructor)
	struct FScriptMulticastDelegate                    ChangeActorBlackboard;                                    // 0x0270(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	TMap<int, struct FUTSkillRuntimeData>              SkillBaseDataMaps;                                        // 0x027C(0x0050) (ZeroConstructor)
	TArray<struct FUTSkillLastCastInfo>                LastCastArray;                                            // 0x02B8(0x000C) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor)
	struct FScriptMulticastDelegate                    OnSkillCast;                                              // 0x02C4(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FSkillActiveRepData                         SyncSkillActiveStateDatas;                                // 0x02D0(0x00A8) (Net)
	struct FSkillAttrRepData                           SyncSkillAttrRepData;                                     // 0x0378(0x00A8) (Net)
	struct FSkillDynamicRepData                        SyncDynamicRepData;                                       // 0x0420(0x00A8) (Net)
	TMap<int, int>                                     IDToSyncSkillCDDatas;                                     // 0x04C8(0x0050) (ZeroConstructor)
	TMap<int, int>                                     ButtonSlotToSkillID;                                      // 0x0504(0x0050) (ZeroConstructor)
	struct FTeammateSkillCDRepData                     TeammateSkillCDRepData;                                   // 0x0540(0x0010)
	TMap<int, int>                                     SkillID2PackageIndex;                                     // 0x0550(0x0050) (ZeroConstructor)
	TArray<struct FSkillCDRepData>                     SyncSkillCDDatas;                                         // 0x058C(0x000C) (Net, ZeroConstructor)
	unsigned char                                      UnknownData03[0x70];                                      // 0x0598(0x0070) MISSED OFFSET
	struct FUTSkillHitInfo                             SkillHitInfo;                                             // 0x0608(0x0028) (Net)
	struct FUTSkillHitEnvInfo                          SkillHitEnvInfo;                                          // 0x0630(0x0028)
	TArray<struct FString>                             MutexMontageGroupBeenPlayed;                              // 0x0658(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData04[0x4];                                       // 0x0664(0x0004) MISSED OFFSET
	int                                                SkillSynRandomSeed;                                       // 0x0668(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FRandomStream                               SkillSynRandStream;                                       // 0x066C(0x0008)
	int                                                SkillSynRandomSeedExpireCount;                            // 0x0674(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x8];                                       // 0x0678(0x0008) MISSED OFFSET
	TArray<struct FSkillParamater>                     SkillParamaters;                                          // 0x0680(0x000C) (Net, ZeroConstructor)
	struct FScriptMulticastDelegate                    OnSkillInitSignature;                                     // 0x068C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillStartEvent;                                          // 0x0698(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillStopEvent;                                           // 0x06A4(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillPhaseChangeEvent;                                    // 0x06B0(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillLevelChangeEvent;                                    // 0x06BC(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillSkinIDChangeEvent;                                   // 0x06C8(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillUpdateCDEvent;                                       // 0x06D4(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	TArray<int>                                        PendingRemoveSkillID;                                     // 0x06E0(0x000C) (ZeroConstructor)
	TArray<struct FUTReplaceSkillData>                 ReplacedSkillDatas;                                       // 0x06EC(0x000C) (BlueprintVisible, Net, ZeroConstructor)
	TMap<int, struct FSkillDisableKeySet>              DisableSkillTagsMap;                                      // 0x06F8(0x0050) (ZeroConstructor)
	TMap<int, struct FSkillDisableKeySet>              DisableSkillIDsMap;                                       // 0x0734(0x0050) (ZeroConstructor)
	TMap<int, struct FSkillLimitKeySet>                LimitSkillTagsMap;                                        // 0x0770(0x0050) (ZeroConstructor)
	TMap<int, struct FSkillLimitKeySet>                LimitSkillIDMap;                                          // 0x07AC(0x0050) (ZeroConstructor)
	struct FMultiSkillSynData                          NewSkillSynData;                                          // 0x07E8(0x00B4) (BlueprintVisible, Net)
	struct FSkillSinglePhaseData                       NewSkillSinglePhaseData;                                  // 0x089C(0x00B4) (BlueprintVisible, Net)
	unsigned char                                      UnknownData06[0x4];                                       // 0x0950(0x0004) MISSED OFFSET
	TMap<uint64_t, struct FUTSkillSimulateData>        SkillSimulateDataMap;                                     // 0x0954(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData07[0x3C];                                      // 0x0990(0x003C) UNKNOWN PROPERTY: SetProperty Skill.UTSkillManagerComponent.AsyncLoadingSkillInst
	struct FUTSkillExecQueue                           SkillExecQueue;                                           // 0x09CC(0x0084)
	uint64_t                                           NetClientSimulateInstID;                                  // 0x0A50(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x10];                                      // 0x0A58(0x0010) MISSED OFFSET
