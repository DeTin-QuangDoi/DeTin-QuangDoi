...
struct FAnimNode_HumanoidLeggedIK : public FAnimNode_SkeletalControlBase
{
	...
	float                                              RootPositionInterpolateSpeed;                             // 0x00F4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FootPositionInterpolateSpeed;                             // 0x00F8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FootRotationInterpolateSpeed;                             // 0x00FC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              RootHeightOffsetScale;                                    // 0x0100(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              RootMaxHeightOffset;                                      // 0x0104(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FootMaxHeightOffset;                                      // 0x0108(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FootMaxPitchOffset;                                       // 0x010C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FootMaxRollOffset;                                        // 0x0110(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              BallShrinkDistance;                                       // 0x0114(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData02[0x90];                                      // 0x0460(0x0090) MISSED OFFSET
};
