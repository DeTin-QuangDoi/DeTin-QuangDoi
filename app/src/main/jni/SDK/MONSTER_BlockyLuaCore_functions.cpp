...
class UColorDesc* UNamedVar::GetNameVarColorDesc()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
struct FLinearColor UNamedVar::GetNameVarColor()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
struct FString UNamedVar::GetColorStr()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
void UNamedVar::CallCustomSelectObject()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
