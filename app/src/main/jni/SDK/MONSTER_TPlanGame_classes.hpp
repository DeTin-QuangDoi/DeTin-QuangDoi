...
{
public:
	bool                                               bForbidSafeBox;                                           // 0x03E0(0x0001) (ZeroConstructor, IsPlainOldData)
...
// 0x0048 (0x18D0 - 0x1888)
class AXTGameMode : public ABattleRoyaleGameModeTeam
{
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x1888(0x0008) MISSED OFFSET
	TArray<class ASTExtraPlayerStartGroup*>            UnOccupiedPlayerStartGroupList;                           // 0x1890(0x000C) (ZeroConstructor)
	bool                                               IsResetPlayerStart;                                       // 0x189C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x189D(0x0003) MISSED OFFSET
	float                                              LastCheckAITime;                                          // 0x18A0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	float                                              CheckAIActiveInterval;                                    // 0x18A4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	float                                              CheckAIActiveRange;                                       // 0x18A8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	int                                                DogTagID;                                                 // 0x18AC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	int                                                BetrayAIDropID;                                           // 0x18B0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	int                                                BetrayAIDropDot;                                          // 0x18B4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bPreSpawnPlayers;                                         // 0x18B8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnableEcapedPlayerInTeam;                                // 0x18B9(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bZombiePVEMode;                                           // 0x18BA(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bMapLoaded;                                               // 0x18BB(0x0001) (ZeroConstructor, IsPlainOldData)
	int                                                iRandomPolicestationIndex;                                // 0x18BC(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FName>                               LoadingPlayerState;                                       // 0x18C0(0x000C) (Edit, BlueprintVisible, ZeroConstructor, Config)
	unsigned char                                      UnknownData02[0x4];                                       // 0x18CC(0x0004) MISSED OFFSET
...
// 0x0040 (0x1068 - 0x1028)
class AXTGameState : public ASTExtraGameStateBase
{
public:
	TMap<int, int>                                     PreciousItemMap;                                          // 0x1028(0x0050) (ZeroConstructor)
...
{
public:
	TArray<struct FSyncRelevantPlayerTask>             SyncRelevantPlayerTask;                                   // 0x16A0(0x000C) (BlueprintVisible, Net, ZeroConstructor)
	TArray<struct FVector>                             EscapePosi;                                               // 0x16AC(0x000C) (BlueprintVisible, Net, ZeroConstructor)
	int                                                BetrayDefaultTime;                                        // 0x16B8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x16BC(0x0004) MISSED OFFSET
	uint64_t                                           Gold;                                                     // 0x16C0(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	bool                                               bIsEscaped;                                               // 0x16C8(0x0001) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	bool                                               bIsRunAway;                                               // 0x16C9(0x0001) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x16CA(0x0002) MISSED OFFSET
	TArray<int>                                        AssetPointsCheckedByTeammate;                             // 0x16CC(0x000C) (BlueprintVisible, Net, ZeroConstructor)
	struct FXTBetrayInfo                               BetrayInfo;                                               // 0x16D8(0x0008) (BlueprintVisible, Net)
