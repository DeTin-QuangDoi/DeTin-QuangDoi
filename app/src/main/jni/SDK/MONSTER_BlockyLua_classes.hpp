...
public:
	...
	unsigned char                                      UnknownData01[0xC4];                                      // 0x094C(0x00C4) MISSED OFFSET
	class UBlockyPresetWidget*                         Host;                                                     // 0x0A10(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0A14(0x0004) MISSED OFFSET
	class UClass*                                      ItemString;                                               // 0x0A18(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UClass*                                      ItemIcon;                                                 // 0x0A1C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x10];                                      // 0x0A20(0x0010) MISSED OFFSET
	class UCanvasPanel*                                CanvasPanel;                                              // 0x0A30(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x0A34(0x0004) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x4];                                       // 0x0A38(0x0004) MISSED OFFSET
	struct FVector2D                                   IconItemSize;                                             // 0x0A3C(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector2D                                   StringItemPadding;                                        // 0x0A44(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector2D                                   IconItemPadding;                                          // 0x0A4C(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	bool                                               bAlignMagnetic;                                           // 0x0A54(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x13];                                      // 0x0A55(0x0013) MISSED OFFSET
...
public:
	unsigned char                                      UnknownData00[0x4];                                       // 0x0A38(0x0004) MISSED OFFSET
	struct FVector2D                                   Padding;                                                  // 0x0A3C(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	bool                                               bAlignGrid;                                               // 0x0A44(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bAlignAnimation;                                          // 0x0A45(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x12];                                      // 0x0A46(0x0012) MISSED OFFSET
